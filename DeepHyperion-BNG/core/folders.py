...
class Folders:
    def __init__(self, lib_folder: str, run_id):
        ...
        self.log: Path = self.root.joinpath(f'logs/run_{run_id}').absolute()
...
folders: Folders = Folders(os.path.dirname(__file__), config.run_id)
