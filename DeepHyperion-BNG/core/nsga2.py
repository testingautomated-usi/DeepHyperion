...
def main(problem: Problem = None, seed=None):
    ...
    problem.uncert_archive.process_population(pop)
    problem.misclass_archive.process_population(pop)
    ...
    for gen in range(1, config.NUM_GENERATIONS):
        ...
        problem.uncert_archive.process_population(offspring + pop)
        problem.misclass_archive.process_population(offspring + pop)
