        ...
        for sample_file in [os.path.join(subdir, f) for f in files if
            ...
            try:
                ...
                with open(sample_file, 'r') as input_file:
                    ...
                    if cast_as == "DeepJanusBeamNG":
                        if sample_file.endswith("simulation.json") or sample_file.endswith("simulation.full.json"):
                            samples.append(DeepJanusBngSample(sample_file))
